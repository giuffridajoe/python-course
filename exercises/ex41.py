...
class Game(object):
	...
	def gold_koi_pond(self):
		...
		print "You peek in and a huge, creepy looking Koi stares at you."
	...
	def bear_with_sword(self):
		...
		if give_it == "give it":
			...
			print "The bear looked puzzled as to why you'd do that."
	...
	def big_iron_gate(self):
		...
		if open_it == "open it":
			...
			print "Oh, but then the bear comes with his kitana and stabs you."
